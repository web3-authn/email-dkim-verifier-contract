...
interface ImportMetaEnv {
  ...
  readonly VITE_EXAMPLE_ACCOUNT_ID?: string;
  readonly VITE_EMAIL_RECOVERER_CONTRACT_ID?: string;
  readonly VITE_DKIM_VERIFIER_CONTRACT_ID?: string;
  readonly VITE_ZK_EMAIL_VERIFIER_CONTRACT_ID?: string;
}
